    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-500">Manage your classes, timetable, and attendance</p>
        </div>

        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          <Link
            href="/staff/classes"
            className="group bg-white rounded-lg border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow"
          >
            ...
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">My Classes</p>
          ...
          >
            ...
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">Recent Attendance</p>
            <p className="text-2xl font-bold text-slate-900">{recentAttendance?.length || 0}</p>
            <p className="text-xs text-slate-500 mt-1">Last 5 records</p>
            <div className="mt-4 flex items-center text-blue-600 text-sm font-medium">
          ...
          >
            ...
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-1">Notifications</p>
              ...
              <div className="px-6 py-4 border-b border-slate-200 bg-slate-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">Classes you teach</p>
                  </div>
                  <Link
                    href="/staff/classes"
                ...
                <div className="space-y-3">
                  {todayClasses.slice(0, 3).map((entry: any, index: number) => (
                    ...
                    >
                      ...
                      <p className="text-slate-500 text-sm">{entry.className}</p>
