      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-500">Stay updated with important announcements</p>
            </div>
            {unreadCount > 0 && (
        ...
        {isLoading ? (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <h3 className="text-slate-900 font-bold text-lg">{notification.title}</h3>
                      {!notification.read && (
          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm shadow-2xl p-12 text-center">
            ...
            <p className="text-slate-500 text-sm mt-2">You're all caught up! New notifications will appear here</p>
          </div>
        )}
      </main>
    </div>
